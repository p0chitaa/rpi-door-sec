...
def unlock():
    ...
    #sleep(1)    # Wait for the lock to close
    open_door()
...
def verify_fingerprint_pin(fingerprint_id):
    ...
    if check_id_exists(fingerprint_id):
        ...
        if check_pin_match(fingerprint_id, entered_pin):
            print("RFID key and PIN verified successfully.")        
